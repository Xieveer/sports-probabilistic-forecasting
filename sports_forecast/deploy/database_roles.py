...
RUNTIME_GRANTS = (
    ...
    "GRANT SELECT ON TABLE predictions, tournament_publication_states, canonical_events, canonical_event_revisions, calendar_coverages, odds_observations TO sf_api_reader",
    "GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE predictions, tournament_publication_states, worker_executions, model_deployments, refresh_locks, canonical_events, canonical_event_revisions, calendar_coverages, refresh_watermarks, bootstrap_imports, odds_observations TO sf_refresh_writer",
    "GRANT USAGE, SELECT ON SEQUENCE predictions_id_seq, tournament_publication_states_id_seq, worker_executions_id_seq, model_deployments_id_seq, refresh_locks_id_seq, canonical_events_id_seq, canonical_event_revisions_id_seq, calendar_coverages_id_seq, refresh_watermarks_id_seq, bootstrap_imports_id_seq, odds_observations_id_seq TO sf_refresh_writer",
