...
| R44    | 🟡 Medium   | High      | ✅     | 44-й ✅ (football features Phase 2; `done_task/R44.md`) |
...
- [x] **R37** — NHL operational: локальный стек, 48h, Pinnacle + edge, пайплайн 12:00 MSK, Telegram ✅ 2026-05-13; см. `done_task/R37.*.md`
  ...
  - [x] **R37.4** — Live Pinnacle NHL (`done_task/R37.4.md`)
...
- [x] **R44** — Football nationals: feature engineering Phase 2 ✅ 2026-06-15; см. `done_task/R44.md`
  - [x] R44.1 — Interview defaults v1 (architect)
  - [x] R44.2 — ADR `football_features_design.md`
  - [x] R44.3 — `conf/sport/football.yaml`: ewm_spans, ewm_metrics, inseason
  - [x] R44.4 — Derived diff/total stat cols в long path
  - [x] R44.5 — Football EWM generators (inject_sport_ewm)
  - [x] R44.6 — streak / coach — пропущено (interview)
  - [x] R44.7 — Tournament select_columns для features
  - [x] R44.8 — DVC features multirun + football_nationals + lock
  - [x] R44.9 — Smoke `dvc repro features` + Pandera
  - [x] R44.10 — HOW_TO / football.md features section
