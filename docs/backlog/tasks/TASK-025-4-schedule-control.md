...
Docker, systemctl, БД или произвольные команды. Результаты каждого запуска
  пишет TASK-025-3/7; полный recovery и history API из TASK-025-7 —
  зависимость.
...
- [ ] Тот же authenticated control API безопасно отдаёт текущий и последние
...
- После TASK-025-3/7. Сервисные роли и systemd template меняются совместно с
