...
появления приоритета. Для запуска candidate отсутствуют согласованные линии,
prematch odds mapping и нормализованный source contract для бросков в створ и
player points. Реализация без этих данных привела бы к неподтверждённым target
и leakage-правилам.
