...
- Workflow / этап: `engineering / TASK-025-3 reviewed; TASK-025-6/7 backlog`.
...
- Выполнено: владелец дал полную постановку в Google Doc; REQ-025 приведён к
  ...
  тестов прошли. Полный recovery/summary/history выделен в TASK-025-7,
  будущие odds — в TASK-025-6.
...
- Предыдущая роль: Reviewer — повторное review TASK-025-3 без блокирующих
  findings, 30 независимых целевых тестов прошли.
- Следующая роль: Product Owner — content commit TASK-025-3; затем Developer —
  TASK-025-6/7, control и Telegram срезы.
...
| [TASK-025-7](tasks/TASK-025-7-data-cycle-recovery-summary.md) | Recovery, terminal stages, summary и run history API | fault matrix, PostgreSQL race, coverage | backlog |
